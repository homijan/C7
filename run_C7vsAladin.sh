...
# Perform analysis.
cd $DIRanalysis
python C7_analysis.py -N $NPROC -s $SIGMA -cl $CL -C7 --labelFluxExt1 ALADIN --pltshow --pltTe -lD1 ALADIN -xp -SH #--Efield --labelEfieldExt1 ALADIN  
#python C7_analysis.py -N $NPROC -s $SIGMA -cl $CL -C7 --labelFluxExt1 ALADIN --pltshow --pltTe -lD1 ALADIN -xp --Efield --labelEfieldExt1 ALADIN #-SH 
