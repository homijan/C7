...
%  , \nonumber
%\end{multline}
Similarly to \eqref{app_eq:BGK_Efield}, one can obtain the~model equation of 
...
the~heat flux maximum, in \figref{fig:C7_Aladin_case5_nonlocal}
...
\figref{fig:C7_Aladin_case5}. Here a~good agreement with
