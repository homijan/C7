...
the~Landau-Beliaev-Budker collisions integral [14, and you can cite beliaev and budker 1956] described in Appendix~\ref{app:CalderKinetics}. 
The~latter is the~relativistic version of the~collision operator 
introduced in \eqref{eq:LFP_model}. 
The aforementioned set of Eqs. in 3D is solved by the PIC code CALDER. 
(cite lefebvre et al., nucl. fus. 43, 629, 2003 and Perez et al. pop 19,083104, 2012).
...
equivalent to a~serie along the spherical harmonics (cite johnston 1960) 
as follows:
\begin{equation}
...
+\vn\cdot \vect{f}_1(t,\mathbf{x},\vmag)$ coupled with the Vlasov-Landau 
\eqref{eq:LFP_model}, leads to the P$_1$ model 
(cite johnston 1960 and kingham 2004):
%\begin{widetext}
\begin{eqnarray}
...
+ \frac{\qe\mathbf{E}}{\me}\frac{\partial f_0}{\partial \vmag}
