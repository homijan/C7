...
\label{sec:Efield}
\begin{comment} % Original E field.
%\begin{multline}
%  %\frac{\vect{j}}{\qe} = 
%  \vect{q}_c \equiv
...
\begin{eqnarray}
 ...
 + G(T_i - \Te)
 \nonumber\\ 
 && - \nabla\cdot\vect{q}_h(f, \E, \B) + Q_{\text{IB}}(I_L)
 , 
 \nonumber
 \\
 \label{eq:ANTH}
...
%\begin{equation}
%  \vect{q}_h(f, \vect{E}) = \frac{\me}{2} \int \vmag^3 \fone \vmag^2~\dI \vmag =
%  \frac{\me}{2} \int \vmag^3 \frac{\E^*}
%  {\nuei} \vmag^2~\dI \vmag ,
%  \label{eq:NonlocalQh}
%\end{equation}
...
The aforementioned hydrodynamic model defines all the~quantities 
in the~fluid frame.
