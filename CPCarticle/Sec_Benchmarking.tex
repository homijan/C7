...
\begin{equation}
  \Iohm\bullet\pdv{\fzero}{\vmag}\E 
  + \frac{\me}{\qe} \Iohm\bullet\vmag \nabla \fzero = 
  \frac{c}{4\pi} \nabla\vect{\times}\B 
  ,
  \label{eq:AmpereKinetic}
\end{equation}
which most probably represents the~most important research output of this work,
where we used the~following notation 
$\Iohm\bullet\vect{g} = - \frac{\qe^2}{\me} \int \vmag \frac{\nuei^2 \vect{g} 
  + \omegaB~\omegaB\cdot\vect{g} + \nuei~\omegaB \vect{\times} \vect{g}}
  {\nuei (\omegaB^2 + \nuei^2)}~\dI \tilde{\vmag}$ showing how $\Iohm$
acts on a~general vector field $\vect{g}$ based on the~kinetic formula 
\eqref{eq:NonlocalOhm}.
