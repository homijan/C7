...
\begin{center}
  \begin{tabular}{c|ccccc}
    ...
    \hline\\
    $v_{lim}^{Z=2}$ & 27.5 & 12.7 & 9.3 & 5.3 & 4.9 \\\\
    \hline\\
    $v_{lim}^{Z=10}$ & 12.5 & 6.3 & 4.9 & 3.0 & 2.4 \\\\
    \hline\hline
  \end{tabular}
  \caption{
  .
...
\begin{eqnarray}
  |\vect{E}_{red}| &=& |\vect{E}_{d}| + |\vect{E}_{iso}| ,
  \nonumber \\
  \vmag \nue + |\vect{E}_{iso}| &=& |\vect{E}_{d}| ,
  \nonumber 
\end{eqnarray}
