...
physical phenomena related to highly mobile particles. In this study 
...
Aladin and Impact and collisional PIC code Calder.
\end{abstract}
...
\input{Sec_BGK_AWBS_FP_diffusion}
...
%\input{Sec_C7}
%\input{Sec_AladinImpactCalder}
%\input{Sec_SimulationResults}
