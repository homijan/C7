...
\title[An~efficient kinetic modeling in plasmas by using the~AWBS transport equation]{An~efficient kinetic modeling in plasmas by using the~AWBS transport equation}% Force line breaks with \\
