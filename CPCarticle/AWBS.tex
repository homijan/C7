...
the~Albritton-Williams-Bernstein-Swartz collision operator \cite{AWBS_PRL1986} 
previously used in \cite{Sorbo_2015} for the~nonlocal electron transport 
...
ingredient in order to capture the~electron kinetics properly.
 %CPR comment - could benefit from a clearer description of what the main results are, preferably with numbers
\end{abstract}
