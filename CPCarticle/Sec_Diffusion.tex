...
\end{equation}
where $\zeta$ can be an~arbitrary constant because it does not affect 
...
\end{equation}
One should notice that $r_B(\Zbar\gg1) = \zeta$, i.e. $\zeta$ can be set 
for example to better address the~nonlocal transport 
behavior. 
