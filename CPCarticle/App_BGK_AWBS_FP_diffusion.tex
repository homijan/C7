...
\begin{eqnarray}
  ...
  &=& 
  \frac{\vmag\xi}{\mfpe} \pdv{}{\vmag}\left(\tilde{\ft} - \fM\right) 
  \nonumber \\
  && + \frac{1}{2}\left(\frac{\Zbar}{\mfpe} + \frac{\xi}{\mfpe}\right)
  \pdv{}{\mu}(1 - \mu^2)\pdv{\tilde{\ft}}{\mu}  \nonumber \\
  &=& \frac{\vmag\xi}{\mfpe} \pdv{}{\vmag}\left(\ft^0 - \fM\right) \nonumber \\ 
  &&\, + \mu\left(\frac{\vmag\xi}{\mfpe} \pdv{\ft^1}{\vmag} 
  - \frac{\Zbar+\xi}{\mfpe}\ft^1\right) ,
  \label{app_eq:AWBS_model_1D}
\end{eqnarray}
where $\nue^* = \xi \nue = \frac{\vmag\xi}{\mfpe}$ with $\xi$ being a~scaling
...
\begin{eqnarray}
  ...
  \frac{\mfpe\qe\Ez}{\xi\me\vmag^2}\frac{\ft^1}{\vmag} ,
  \label{app_eq:AWBS_f0} \\
  \frac{\vmag\xi}{\mfpe} \pdv{\ft^1}{\vmag} 
  - \frac{\Zbar+\xi}{\mfpe}\ft^1 &=&
...
\begin{equation}
  \pdv{\ft^1_{AWBS}}{\vmag} 
  - \frac{\Zbar+\xi}{\vmag\xi}\ft^1_{AWBS} =
  \frac{\mfpe}{\vmag\xi} 
  \left(\pdv{\fM}{z} + \frac{\qe\Ez}{\me\vmag}\pdv{\fM}{\vmag}\right) .
...
$Kn\frac{\vth^2}{\xi\vmag^2}\frac{f^1}{\vmag}$.
