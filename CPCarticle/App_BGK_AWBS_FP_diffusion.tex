...
\begin{eqnarray}
  ...
  \label{app_eq:BGK_f0} \\
  \ft^1 &=& - \frac{\mfpe}{\Zbar}
  \left( \pdv{}{z}\left(f^0 - \frac{f^2}{2}\right) + \frac{\qe\Ez}{\me\vmag}\pdv{}{\vmag} \left(f^0 - \frac{f^2}{2}\right) \right) , 
  \label{app_eq:BGK_f1}
  \\
...
Multiplication of the~electron-electron collision contribution can be 
