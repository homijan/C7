...
The~first \corrCPR{modern attempts at} kinetic modeling of plasma can be \corrCPR{traced} back 
...
(VFP)~\cite{Planck_1917}. %CPR comment - do you need to start so far back in the history of plasma kinetic theory?
...
The~ \corrCPR{resulting} expressions for current and heat flux are widely used in \corrCPR{\st{every}} plasma 
hydrodynamic models.
...
the~mean free path of electrons.% when colliding with ions.
...
$f^0$, which of course needs to tend to the~Maxwell-Boltzmann distribution.% CPR comment - again not sure you need to go back this far in history
...
since the~nonlocal regime is characterized by $L_T\sim\mfpe$. %CPR comment - which electrons? I would say thi is true for the heat carryong electrons at 3-4 times the thermal speed but not the thermal electrons
It was also shown that a~thermal transport inhibition \cite{Bell_1981_83} 
\corrCPR{around the peak of the temperature gradient}, and a~nonlocal preheat \corrCPR{ahead of the main heat wave front}, 
...
are needed. \corrCPR{Although some VFP simulations on experimentally relevant timescales have been performed (for recent examples see \cite{Hawreliak04,Ridgers08,Willingale10,Bissell10,Joglekar14,Joglekar16,Henchen18}, an extensive review has been conducted by Thomas et al. \cite{Thomas13}), their relative computational inefficiency severly limits the range of simulations that can be performed.} % Should cite some of the existing literature on VFP simulations. I chose what I think represents a decent range but feel free to cut or expand.

It is the~purpose of this paper to present an~efficient alternative 
to \corrCPR{a full solution of the VFP equation to accurately calculate non-local transport,} based on the~Albritton-Williams-Bernstein-Swartz 
