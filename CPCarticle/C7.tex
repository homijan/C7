...
\begin{multline}
  ...
  \left(\pdv{\ft^1\mfpei}{\vmag} - \frac{\ft^1\mfpei}{\vmag} \right)
  \left(\pdv{\gt^1\mfpei}{\vmag} - \frac{\gt^1\mfpei}{\vmag} \right) \\
  %= \frac{\partial^2 \ft^0 + \ft^1\mfpei\mu}{\partial \vmag^2}
  %\frac{\partial^2 \gt^0 + \gt^1\mfpei\mu}{\partial \vmag^2}
  %+ \frac{2}{\vmag^2}\pdv{\ft^0 + \ft^1\mfpei\mu}{\vmag}
  %\pdv{\gt^0 + \gt^1\mfpei\mu}{\vmag} \\
  %- \mu\frac{2}{\vmag^3}\left(
  %\pdv{\ft^0 + \ft^1\mfpei\mu}{\vmag}\gt^1\mfpei 
  %+ \pdv{\gt^0 + \gt^1\mfpei\mu}{\vmag}\ft^1\mfpei\right)\\
  %+ \frac{2}{\vmag^2}
  %\left(\pdv{\ft^1\mfpei}{\vmag} - \frac{\ft^1\mfpei}{\vmag} \right)
  %\left(\pdv{\gt^1\mfpei}{\vmag} - \frac{\gt^1\mfpei}{\vmag} \right) \\
...
\begin{multline}
  ...
  + \frac{1}{\vmag^2}\pdv{\ft^0}{\vmag}\pdv{\gt^0}{\vmag} \right)
  \\
  + \frac{\mu}{n_e}\Bigg[8\pi \ft^0 \ft^1\vmag^4 + 
  \frac{1}{2}\left(\frac{\partial^2 \ft^0}{\partial \vmag^2}
...
%  \frac{\me c^2}{4\pi\qe^2}
%  \int_{\Gamma} \left(\Wcurl\times\tB\right)\cdot\vn_{\Gamma}\, \dI\Gamma ,
...
\begin{equation}
  \matr{D_{I}V_{E}} = \ID^T_{\left(\MI\right)} 
...
\begin{multline}
  ...
  - \Delta\vmag \ID_{\left(\MA\right)} \right) \cdot
  \left[  
  \IM^{0^{-1}}_{(\nue)} \cdot \matr{D_{I}V_{E}}\cdot\fone^n 
  + \pdv{\vect{\fM}}{\vmag}
...
\begin{figure}[tbh]
  \begin{center}
    \begin{tabular}{cc}
      \includegraphics[width=0.55\textwidth]{../tmp/current_Z100_Kn1e-4.png} &
      \includegraphics[width=0.55\textwidth]{../tmp/heatflux_Z100_Kn1e-4.png} \\
      \includegraphics[width=0.55\textwidth]{../tmp/current_Z100_Kn1e-3.png} &
      \includegraphics[width=0.55\textwidth]{../tmp/heatflux_Z100_Kn1e-3.png} \\
      \includegraphics[width=0.55\textwidth]{../tmp/current_Z100_Kn5e-3.png} &
      \includegraphics[width=0.55\textwidth]{../tmp/heatflux_Z100_Kn5e-3.png}
    \end{tabular}
  \caption{}
  \end{center}
...
\begin{figure}[tbh]
  \begin{center}
    \begin{tabular}{c} 
      \includegraphics[width=0.7\textwidth]{../tmp/kinetics_Z100_Kn1e-4.png} \\
      \includegraphics[width=0.7\textwidth]{../tmp/kinetics_Z100_Kn1e-3.png} \\
      \includegraphics[width=0.7\textwidth]{../tmp/kinetics_Z100_Kn5e-3.png}
    \end{tabular}
  \caption{}
  \end{center}
  \label{fig:C7explimpl}
...
\begin{figure}[tbh]
  \begin{center}
    \begin{tabular}{cc}
      \includegraphics[width=0.55\textwidth]{../tmp/current_Z1_Kn1e-3.png} &
      \includegraphics[width=0.55\textwidth]{../tmp/heatflux_Z1_Kn1e-3.png} \\
      \includegraphics[width=0.55\textwidth]{../tmp/current_Z1_Kn1e-2.png} &
      \includegraphics[width=0.55\textwidth]{../tmp/heatflux_Z1_Kn1e-2.png} \\
      \includegraphics[width=0.55\textwidth]{../tmp/current_Z1_Kn5e-2.png} &
      \includegraphics[width=0.55\textwidth]{../tmp/heatflux_Z1_Kn5e-2.png}
    \end{tabular}
  \caption{}
  \end{center}
  \label{fig:C7explimpl}
...
\begin{figure}[tbh]
  \begin{center}
    \begin{tabular}{c} 
      \includegraphics[width=0.7\textwidth]{../tmp/kinetics_Z1_Kn1e-3.png} \\
      \includegraphics[width=0.7\textwidth]{../tmp/kinetics_Z1_Kn1e-2.png} \\
      \includegraphics[width=0.7\textwidth]{../tmp/kinetics_Z1_Kn5e-2.png}
    \end{tabular}
  \caption{}
  \end{center}
  \label{fig:C7explimpl}
...
\begin{figure}[tbh]
  \begin{center}
    \begin{tabular}{c} 
      \includegraphics[width=0.7\textwidth]{../tmp/current_Z1_Kn25e-4.png} \\
      \includegraphics[width=0.7\textwidth]{../tmp/heatflux_Z1_Kn25e-4.png} \\
      \includegraphics[width=0.7\textwidth]{../tmp/kinetics_Z1_Kn25e-4.png}
    \end{tabular}
  \caption{}
  \end{center}
  \label{fig:C7explimpl}
...
\begin{figure}[tbh]
  \begin{center}
    \begin{tabular}{cc}
      ...
      \includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/P5_kinetics_niZ100_Kn1e-3_implexpl.png} 
    \end{tabular}
  \caption{
  C7 explicit (63140 groups) vs implicit (25 groups) for Kn = 0.001 nonlocality. $t_{expl} \approx 4000\times t_{impl}$.
  }
  \end{center}
  \label{fig:C7explimpl}
\end{figure}
...
\begin{figure}[tbh]
  \begin{center}
    \begin{tabular}{cc}
        \includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/P5_fluxes_niZ100_Kn1e-10_implexpl.png} &
        \includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/P5_fluxes_niZ1_Kn1e-10_implexpl.png} \\
        \includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/P5_heatfluxes_niZ100_Kn1e-10_implexpl.png} &
        \includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/P5_heatfluxes_niZ1_Kn1e-10_implexpl.png} \\
      \includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/P5_kinetics_niZ100_Kn1e-10_implexpl.png} &          
      \includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/P5_kinetics_niZ1_Kn1e-10_implexpl.png}
    \end{tabular}
  \caption{
  C7 explicit vs implicit for diffusive regime (Kn = 10$^{-10}$) 
  including the~SH Efield.
  }
  \end{center}
  \label{fig:C7explimpl}
\end{figure}
...
\begin{eqnarray}
  ...
  \left(\ID^T_{\left(\MI\right)}
  + \frac{2}{\vmag^2}\IV^T_{\left(\tE\right)}\right) \cdot \fone
  + \frac{1}{\vmag}\IV^T_{\left(\tE_s\right)} \cdot 
  \pdv{\fone}{\vmag} ,  
  \nonumber \label{eq:OOE_semiM1hosf0} \\
  \IM^1_{(\nue)} \cdot \pdv{\fone}{\vmag}  
  &=& 
  - \ID_{\left(\MA\right)}\cdot\davfzero
  + \frac{1}{\vmag}\IV_{\left(\MA \cdot \tE_s\right)} \cdot
  \pdv{\davfzero}{\vmag}
  + \frac{1}{\vmag}\left(
  \IM^1_{\left( \nutot \right)} + \IB_{\left( \tB \right)}  
  \right) \cdot \fone
...
\begin{equation}
  \pdv{\davfzero}{\vmag}  
  = \frac{1}{\vmag}
  \IM^{0^{-1}}_{(\nue)} \cdot \IV^T_{\left(\tE_s\right)} \cdot 
  \pdv{\fone}{\vmag} 
  + \IM^{0^{-1}}_{(\nue)} \cdot \matr{D_{I}V_{E}}\cdot  
  \left(\fone^n 
  + \Delta\vmag\pdv{\fone}{\vmag}\right) .
...
\begin{multline}
  \IM^1_{(\nue)} \cdot \pdv{\fone}{\vmag}  
  = 
  \left(\frac{1}{\vmag}\IV_{\left(\MA \cdot \tE_s\right)}
  - \Delta\vmag \ID_{\left(\MA\right)} \right) \cdot
  \IM^{0^{-1}}_{(\nue)} \cdot 
  \left(\frac{1}{\vmag} \IV^T_{\left(\tE_s\right)} 
  + \Delta\vmag \matr{D_{I}V_{E}}
  \right)
  \cdot \pdv{\fone}{\vmag}
  \\
...
\end{multline}
where the~only unknown is $\pdv{\fone}{\vmag}$. 

\textbf{Embedded iteration scheme begins!}
...
\begin{multline}
  ...
  - \Delta\vmag \ID_{\left(\MA\right)} \cdot
  \IM^{0^{-1}}_{(\nue)} \cdot 
  \frac{1}{\vmag} \IV^T_{\left(\tE_s\right)} 
  \cdot \pdv{\fone^k}{\vmag}
  \\
  + \frac{1}{\vmag}\left(\IB_{\left( \tB \right)} 
  + \IM^1_{\left( \nutot \right)}\right) 
  \cdot \fone^n
...
where the~only unknown is $\pdv{\fone}{\vmag}$.
\begin{eqnarray}
  \matr{A}_{\fone} \cdot \pdv{\fone^{k+1}}{\vmag} &=&
  \vect{b_1}^n + \vect{b_1}^k ,
  \label{eq:OOE_fullP1hosf1_embedded}
  \\
  \pdv{\davfzero^{k+1}}{\vmag}  
  &=& \vect{b_0}^n + \vect{b_0}^k + \vect{b_0}^{k+1} ,
  \label{eq:OOE_fullP1hosf0_embedded}
\end{eqnarray}
\begin{eqnarray}
  \matr{A}_{\fone} &=&   
  \left[\IM^1_{(\nue)} + \Delta\vmag^2 \ID_{\left(\MA\right)} \cdot
  \IM^{0^{-1}}_{(\nue)} \cdot 
  \matr{D_{I}V_{E}}
  - \frac{\Delta\vmag}{\vmag}\left(\IB_{\left( \tB \right)} 
  + \IM^1_{\left( \nutot \right)}\right)\right] ,
  \nonumber \\
  \vect{b_1}^n &=& \frac{1}{\vmag}\IV_{\left(\MA \cdot \tE\right)} \cdot
  \pdv{\tvfM^n}{\vmag}
  - \ID_{\left(\MA\right)}\cdot\left(\tvfM^n + \davfzero^n\right)
  + \frac{1}{\vmag}\left(\IB_{\left( \tB \right)} 
  + \IM^1_{\left( \nutot \right)}\right) 
  ...
  \IM^{0^{-1}}_{(\nue)} \cdot \matr{D_{I}V_{E}}\cdot\fone^n ,
  \nonumber \\
  \vect{b_1}^k &=& \frac{1}{\vmag}\IV_{\left(\MA \cdot \tE_s\right)} \cdot
  \pdv{\davfzero^k}{\vmag}
  - \frac{\Delta\vmag}{\vmag} \ID_{\left(\MA\right)} \cdot
  \IM^{0^{-1}}_{(\nue)} \cdot \IV^T_{\left(\tE_s\right)} 
  \cdot \pdv{\fone^k}{\vmag} ,
  \nonumber \\
  \vect{b_0}^n &=& \IM^{0^{-1}}_{(\nue)} \cdot \matr{D_{I}V_{E}}\cdot \fone^n ,
  \nonumber \\
  \vect{b_0}^k &=& \frac{1}{\vmag}
  \IM^{0^{-1}}_{(\nue)} \cdot \IV^T_{\left(\tE_s\right)} \cdot 
  \pdv{\fone^k}{\vmag} ,
  \nonumber \\
  \vect{b_0}^{k+1} &=&
...
\textbf{Embedded iteration scheme ends!}

Once \eqref{eq:OOE_fullP1hosf1}
is solved the~completion of the~solution 
...
\begin{figure}[tbh]
  \begin{center}
    \begin{tabular}{cc}
      %\includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/P5_heatfluxes_niZ100_Kn5e-6.png} &
      %\includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/P5_kinetics_niZ100_Kn5e-6.png} \\
      %\includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/P5_heatfluxes_niZ50_Kn2e-5.png} &
      %\includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/P5_kinetics_niZ50_Kn2e-5.png} \\
      %\includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/P5_heatfluxes_niZ20_Kn13e-5.png} &
      %\includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/P5_kinetics_niZ20_Kn13e-5.png} \\
