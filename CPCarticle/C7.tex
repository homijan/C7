...
\begin{figure}[tbh]
  \begin{center}
    \begin{tabular}{c}
      ...
      \includegraphics[width=1.0\textwidth]{../VFPdata/GD_Hohlraum/kinetics_10ps_xpoint_1500microns.png}
    \end{tabular}
  \caption{
  Kinetics profiles for max(flux) point and 1500 microns point for the case of 10ps VFP temperature profile, ne and Z Hydra profiles. 
  }
  \end{center}
  \label{fig:AWBScorrection_f1}
\end{figure}
