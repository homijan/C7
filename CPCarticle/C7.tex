...
\begin{figure}[tbh]
  \begin{center}
    ...
    \end{tabular}
  \caption{
  C7 explicit vs implicit for Kn = 0.001 nonlocality. $t_{expl} \approx 2000\times t_{impl}$.
  }
  \end{center}
...
\begin{figure}[tbh]
  \begin{center}
    ...
    \end{tabular}
  \caption{
  C7 explicit (63109 groups) vs implicit (25 groups) for Kn = 0.001 nonlocality.
  }
  \end{center}
  \label{fig:C7explimpl}
\end{figure}
