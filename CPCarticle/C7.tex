...
\begin{figure}[tbh]
  \begin{center}
    \begin{tabular}{cc}
      ...
      %\includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/P5_heatfluxes_Z5_Kn1e-2.png} &
      %\includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/P5_kinetics_Z5_Kn1e-2.png} \\
      ...
      %\includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/P5_heatfluxes_Z20_Kn25e-4.png} &
      %\includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/P5_kinetics_Z20_Kn25e-4.png} \\
