...
\title{C7: An~efficient~7D~plasma~kinetic~code~born~for~hydro}
...
\begin{figure}[tbh]
  \begin{center}
    \begin{tabular}{c}
      \includegraphics[width=0.7\textwidth]{../fe_data/diff_f1_Z1.png} \\
      \includegraphics[width=0.7\textwidth]{../fe_data/diff_f1_Z10.png} \\
      \includegraphics[width=0.7\textwidth]{../fe_data/diff_f1_Z50.png}
    \end{tabular}
  \caption{
...
\begin{figure}[tbh]
  \begin{center}
    \begin{tabular}{c}
      \includegraphics[width=0.8\textwidth]{../fe_data/diff_correction_fit.png} 
    \end{tabular}
  \caption{
