...
%\begin{equation}
%  \intO \Wcurl\cdot\left[
%  \Wcurl^T\cdot\pdv{\E}{t} + 4\pi \Wone^T\cdot\vect{j} - c\, \nabla\times(\Wdiv^T\cdot\B)
%  \right]\, \dI\Omega = \vect{0} ,
%  \label{eq:HOFAmpere} 
%\end{equation}
\begin{multline}
  \intO \Wcurl\cdot\left[
  \Wcurl^T\cdot\pdv{\E}{t} - \frac{4\pi\qe^2}{\me}
  \int\frac{\vmag}{\nutot} \pdv{\fzero}{\vmag}\vmag^2\, \dI\vmag\, \MA\cdot\Wcurl^T\cdot\E 
  \right]\, \dI\Omega
   = \\ 
  4\pi\qe
  \intO \Wcurl\cdot
...
%\begin{multline}
%  \intO \left[\Wcurl\cdot
%  \Wcurl^T\cdot\pdv{\E}{t} + 4\pi \Wcurl\cdot\Wone^T\cdot\vect{j} 
%  - c\, \nabla\times\Wcurl\cdot\Wdiv^T\cdot\B \right]\, \dI\Omega = \\
%  \int_{\Gamma} c\, \left(\Wcurl\times\Wdiv^T\cdot\B\right)\cdot\vn_{\Gamma}\, \dI\Gamma ,
%  \label{eq:HOFAmpere} 
%\end{multline}
\begin{multline}
  \intO \Wcurl\cdot\left[
  ...
  c\, \int_{\Gamma} \left(\Wcurl\times\B\right)\cdot\vn_{\Gamma}\, \dI\Gamma ,
