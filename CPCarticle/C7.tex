...
\begin{figure}[tbh]
  \begin{center}
    \begin{tabular}{c}
      \includegraphics[width=0.7\textwidth]{../results/fe_analysis/figs/diff_f1_comparison_Z1.png} \\
      \includegraphics[width=0.7\textwidth]{../results/fe_analysis/figs/diff_f1_comparison_Z10.png} \\
      \includegraphics[width=0.7\textwidth]{../results/fe_analysis/figs/diff_f1_comparison_Z50.png} 
    \end{tabular}
  \caption{
...
\begin{figure}[tbh]
  \begin{center}
    \begin{tabular}{c}
      \includegraphics[width=0.8\textwidth]{../results/fe_analysis/figs/diff_AWBScorrection_fit.png} 
    \end{tabular}
  \caption{
...
\begin{figure}[tbh]
  \begin{center}
    \begin{tabular}{c}
      \includegraphics[width=0.8\textwidth]{../results/fe_analysis/figs/diff_f1_C7AWBScorrection_Z4.png} 
    \end{tabular}
  \caption{
...
\begin{figure}[tbh]
  \begin{center}
    \begin{tabular}{cc}
      \includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/f1_comparison_Kn1e-6_Z4.png} &
      \includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/f1_comparison_Kn1e-5_Z4.png} \\
       \includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/f1_comparison_Kn16e-6_Z4.png} &
      \includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/f1_comparison_Kn1e-4_Z4.png}     
    \end{tabular}
  \caption{
