...
\begin{figure}[tbh]
  \begin{center}
    \begin{tabular}{cc}
      \includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/P5_heatfluxes_Z1_Kn1e-2.png} &
      \includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/P5_kinetics_Z1_Kn1e-2.png} \\ 
      \includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/P5_heatfluxes_Z10_Kn1e-2.png} &
      \includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/P5_kinetics_Z10_Kn1e-2.png} \\
      \includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/P5_heatfluxes_Z20_Kn1e-2.png} &
      \includegraphics[width=0.5\textwidth]{../results/fe_analysis/figs/P5_kinetics_Z20_Kn1e-2.png}
    \end{tabular}
  \caption{
  The~nonlocal heat flux calculations. Kn$\approx \mfpei/L$ has been kept fixed.
  }
  \end{center}
  \label{fig:AWBSvsSH_f1}
\end{figure}
