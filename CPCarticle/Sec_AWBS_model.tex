...
\begin{equation}
  \pdv{\ft}{t} + \vv\cdot\gx \ft + \frac{\qe}{\me}\E \cdot\gv \ft = 
  C_{ee}(f) + C_{ei}(f) ,
...
$\E$ is the~electric field in plasma, $\qe$ and $\me$ being the~charge and mass
of electron.
...
to be motionless compared to electrons. The~scattering operator accounts
...
The~e-e collision operator needs to be linearized for efficient computations.
Fish introduced a~linear form of $C_{ee}$ in \cite{Fish_RMP1987} 
...
which simplifies importantly the~form \eqref{eq:LFP_model}.
