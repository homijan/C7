...
cd VFPdata
cd GD_Hohlraum
python ../loadPhilippegrace.py -f gdhohlraum_xmic_ne1e20cm3_interp -o ne_ -x -s -m 2e24
...
# Run C7.
#mpirun -np $NPROC C7 -p $PROBLEM -m data/segment01.mesh -rs $RS -tf 0.0 -ok $F1ORDER -ot $F0ORDER -no-vis -fa -print -sigma $SIGMA -cl $CL -L $L -xp $XPOINT -minG $MING -s 3 -cfl 1e10 -S0 1.0 -dE 0.1 -Em 100 | tee C7E.out
...
# Perform analysis.
cd $DIRanalysis
#python C7_analysis.py -N $NPROC -s $SIGMA -cl $CL -C7 --labelFluxExt1 IMPACT --labelFluxExt2 SNBs --labelFluxExt3 Local --pltshow --Efield -SH #-xp #--vlimshow #--AWBSstar #--AWBSoriginal

python C7_analysis.py -N $NPROC -s $SIGMA -cl $CL -C7 --labelFluxExt3 Local --pltshow --Efield -SH #-xp #--vlimshow #--AWBSstar #--AWBSoriginal
